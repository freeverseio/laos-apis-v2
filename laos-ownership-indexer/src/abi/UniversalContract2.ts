...
export const events = {
    ...
    NewERC721Universal: event("0xb4e1dc82d38c41e054f095ea5f4fc1d08bd9b949513f8ed2544ab8b47b1a8243", "NewERC721Universal(address,string,string,string)", {"newContractAddress": p.address, "baseURI": p.string, "name": p.string, "symbol": p.string}),
