module.exports = class Data1738071087531 {
    name = 'Data1738071087531'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "polygon_ownership_contract" ("id" character varying NOT NULL, "address" text, "laos_contract" text, "name" text, "symbol" text, "bytecode_hash" text, CONSTRAINT "PK_89d5626d86e841b70ef7c1784d2" PRIMARY KEY ("id"))`)
