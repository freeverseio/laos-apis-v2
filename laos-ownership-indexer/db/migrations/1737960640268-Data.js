module.exports = class Data1737960640268 {
    name = 'Data1737960640268'

    async up(db) {
        await db.query(`CREATE TABLE "polygon_transfer" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "tx_hash" text NOT NULL, "asset_id" character varying, CONSTRAINT "PK_4e5638dcaf2d7479c8645657526" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "polygon_asset" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "token_id" numeric NOT NULL, "owner" text NOT NULL, "ownership_contract_id" character varying, CONSTRAINT "PK_95aa8f2b794de6d6c14026315b8" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_1532b946e33c6e82a73ba8a1b6" ON "polygon_asset" ("ownership_contract_id") `)
        await db.query(`CREATE TABLE "polygon_ownership_contract" ("id" character varying NOT NULL, "address" text, "chain_id" integer NOT NULL, "laos_contract" text, "name" text, "symbol" text, "bytecode_hash" text, CONSTRAINT "PK_89d5626d86e841b70ef7c1784d2" PRIMARY KEY ("id"))`)
