module.exports = class Data1738854586307 {
    name = 'Data1738854586307'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "ethereum_ownership_contract" ("id" character varying NOT NULL, "address" text, "laos_contract" text, "base_uri" text, "laos_chain_id" integer, "name" text, "symbol" text, "bytecode_hash" text, CONSTRAINT "PK_b0ecc1721af1dd4e5e900ddf54d" PRIMARY KEY ("id"))`)
